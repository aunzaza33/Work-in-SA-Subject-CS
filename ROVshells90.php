    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="navigation">
            ...
            <div id="navbar">
                ...
                <a href="ROVshells90.php?logout='1'" ;>Logout &#8739;</a>
        ...
        <div class="column">
            <div class="card">
                ...
                <div class="container">
                    ...
                    <h2 style="color: white">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;จำนวน : 110 คูปอง</h2>
            ...
            <div class="container" style="width: 500px;">
                <div class="header">
                    ...
                    <form action="input_db.php" method="post">
                        ...
                        <input type="hidden" id="postId" name="ROV_value90" value="110 คูปอง">
                        <input type="hidden" id="postId" name="ROV_cost90" value="90 บาท">
                    ...
                    <div class="container text-center" style="margin-left: 90%; width: 500px;">
                        ...
                        <form action="input_db.php" method="post" class="form-horizontal" enctype="multipart/form-data" style="margin-top: -120px; color:crimson">
