...
<body>
    ...
    <nav>
        <div id="navbar">
            ...
            <a href="shop_rov.php?logout='1'" ;>Logout &#8739;</a>
        ...
        <div class="column">
            <div class="card">
                ...
                <div class="container">
                    ...
                    <p><button onclick="window.location.href='ROVshells90.php'" class="button">ซื้อสินค้า</button></p>
                </div>
            </div>
        </div>
        ...
        <div class="column">
            <div class="card">
                ...
                <div class="container">
                    ...
                    <p><button onclick="window.location.href='ROVshells150.php'" class="button">ซื้อสินค้า</button></p>
                </div>
            </div>
        </div>
        ...
        <div class="column">
            <div class="card">
                ...
                <div class="container">
                    ...
                    <p><button onclick="window.location.href='ROVshells300.php'" class="button">ซื้อสินค้า</button></p>
                </div>
            </div>
        </div>
        ...
        <div class="column">
            <div class="card">
                ...
                <div class="container">
                    ...
                    <p><button onclick="window.location.href='ROVshells500.php'" class="button">ซื้อสินค้า</button></p>
                </div>
            </div>
        </div>
    </div>
