    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="navigation">
            ...
            <div id="navbar">
                ...
                <a href="ROVshells500.php?logout='1'" ;>Logout &#8739;</a>
...
toggle between hiding and showing the dropdown content */
    ...
    <div class="row" style="margin-top:100px;">
        <div class="column">
            <div class="card">
                <img src="image/shells500.png" alt="Snow" style="width:100%">
                <div class="container">
                    <h2 style="color: white">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ชื่อสินค้า : ROV</h2>
                    <h2 style="color: white">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;จำนวน : 620 คูปอง</h2>
                    <h2 style="color: white">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ราคา : 500 บาท</h2>
                </div>
            </div>
        </div>
        <div class="column" style="margin-top: -70px; margin-left: 100px; width: 1000px;">
            <div class="container" style="width: 500px;">
                <div class="header">
                    <h1>กรุณากรอกข้อมูลเพื่อสั่งซื้อ</h1>
                    <form action="input_db.php" method="post">
                        <input type="hidden" id="postId" name="ROV_name90" value="ROV">
                        <input type="hidden" id="postId" name="ROV_value90" value="620 คูปอง">
                        <input type="hidden" id="postId" name="ROV_cost90" value="500 บาท">
                        <input type="hidden" id="postId" name="status" value="A">
                        <div class="input-group">
                            <label for="email">อีเมล &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;</label>
                            <input type="email" style="height: 25px; width: 300px; color: black" placeholder="xxxx.@gmail.com" name="email" required>
                            <br><br>
                            <label for="password">รหัสผ่าน :&nbsp;&nbsp;</label>
                            <input type="id" style="height: 25px; width: 300px; color: black" placeholder="******" name="password" required>
                        </div>
                        ...
                        <div class="button1">
                            <button type="submit" style="height: 65px; width: 300px; margin-left: -175px; margin-top: 50%; font-size: 30px;" name="submit90" class="btn">ตรวจสอบข้อมูล</button>
                        </div>
                    </form>
                    <div class="container text-center" style="margin-left: 90%; width: 500px;">
                        ...
                        <form action="" method="post" class="form-horizontal" enctype="multipart/form-data" style="margin-top: -120px; color:crimson">

                            <div class="form-group">
                                <div class="row">
                                    <label style="font-size: 20px;" for="name" class="col-sm-3 control-label">แนบหลักฐานการชำระเงิน</label>
                                    <div>
