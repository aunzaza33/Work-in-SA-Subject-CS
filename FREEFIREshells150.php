...
<head>
    ...
    <title>select_freefire150</title>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="navigation">
            ...
            <div id="navbar">
                ...
                <a href="FREEFIREshells150.php?logout='1'" ;>Logout &#8739;</a>
        ...
        <div class="column">
            <div class="card">
                ...
                <div class="container">
                    ...
                    <h2 style="color: white">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;จำนวน : 517 &#128142 </h2>
            ...
            <div class="container" style="width: 500px;">
                <div class="header">
                    ...
                    <form action="input_db_freefire.php" method="post">
                        ...
                        <input type="hidden" id="postId" name="FREEFIRE_value90" value="517 เพชร">
                        <input type="hidden" id="postId" name="FREEFIRE_cost90" value="150 บาท">
