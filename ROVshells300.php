    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="navigation">
            ...
            <div id="navbar">
                ...
                <a href="ROVshells300.php?logout='1'" ;>Logout &#8739;</a>
...
toggle between hiding and showing the dropdown content */
    ...
    <div class="row" style="margin-top:100px;">
        <div class="column">
            <div class="card">
                <img src="image/shells300.png" alt="Snow" style="width:100%">
                <div class="container">
                    <h2 style="color: white">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ชื่อสินค้า : ROV</h2>
                    <h2 style="color: white">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;จำนวน : 370 คูปอง</h2>
                    <h2 style="color: white">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ราคา : 300 บาท</h2>
                </div>
            </div>
        </div>
            ...
            <div class="container" style="width: 500px;">
                <div class="header">
                    ...
                    <form action="input_db.php" method="post">
                        ...
                        <input type="hidden" id="postId" name="ROV_value90" value="370 คูปอง">
                        <input type="hidden" id="postId" name="ROV_cost90" value="300 บาท">
