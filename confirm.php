    ...
    <div class="row" style="margin-top:20px; margin-left: 33%;">
        <div class="column" style="width: 500px; ">
            <div style="color: white; margin-left: 8.5%; font-size: 20px;"><?php
                                                                            ...
                                                                            echo 'ชื่อสินค้า  :', $_SESSION['ROV_name900'], '<br>', 'จำนวน :', $_SESSION['ROV_value900'], '<br>', 'ราคา :', $_SESSION['ROV_cost900'], '<br>', '<br>';
                                                                            echo 'อีเมล  :', $_SESSION['emailuser'], '<br>', 'รหัสผ่าน :', $_SESSION['passworduser'];
